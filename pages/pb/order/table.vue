...
<template>
	<div class="layout1">
		...
		<main class="order-page order-main">
			...
			<section class="store-notice-event">
				<div class="memo-event-slider">
					<swiper class="slider-item" :speed="700" :autoplay="{ delay: 4000, disableOnInteraction: false }"
						:loop="true">
						<swiper-slide>
							<div class="item-overflow">
								<i class="icon-notice"></i>
								<button type="button" class="btn-link" @click="isMemo = true">
