	...
	<div class="layout1">
		...
		<main class="order-page">
			<section class="order-dashboard">
				...
				<div class="togo-info">
					<dl>
						<dt><button class="btn-tooltip">픽업시간 <i class="btn_tooltip_16"></i></button></dt>
						<dd>55분 후</dd>
					</dl><!--v-if-->
					<dl class="store-address">
						<dt><a href="/pb/map" class="store-map-link">매장위치</a><button
								class="btn-copy">주소복사</button></dt>
						<dd><input type="text" readonly class="input-address">
			...
			<div class="btn-wrap-fixed">
				<div class="btn-row"><button class="btn-cart-link"> 장바구니 <span class="count">0</span></button><button
						class="btn-order-link">0원 <em data-v-67f37c94="">포장</em> 주문 </button></div>
			</div>
		</main>
...
@import '@/assets/default/scss/components/order/orderDashboardTakeout';


@import '@/assets/default/scss/components/order/menuList';
@import '@/assets/default/scss/components/store/storeWorkTime';</style>
