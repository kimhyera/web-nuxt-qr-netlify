...
import BusinessTime from '@/components/default/popup/BusinessTime.vue'
import DeliveryTip from '@/components/default/popup/DeliveryTip.vue'
...
<template>
	<div class="layout1">
		...
		<nav class="navbar">
			<ul class="nav">
				...
				<li>
					<NuxtLink to="/pb/main">매장소개</NuxtLink>
				</li>

				<li>
					<NuxtLink to="/pb/order/1001">배달</NuxtLink>
				</li>

				<li>
					<NuxtLink to="/pb/order/1002">포장</NuxtLink>
				</li>

				<li>
					<NuxtLink to="/pb/order/1008">테이블</NuxtLink>
				</li>


				<li>
					<NuxtLink to="/pb/waiting">대기</NuxtLink>
				</li>
				...
				<li>
					<NuxtLink to="/pb/booking">예약</NuxtLink>
				</li>
		...
		<main class="order-page">
			<section class="order-dashboard">
				...
				<div class="store-business-time"><!-- 영업중 -->
					<div class="time-row outline"><span class="status open">영업중</span><span class="time"><strong>목</strong>
							09:00 ~ 19:00</span><button class="btn-modal-time" @click="showBusinessTime">전체보기</button></div><!-- 영업시간 --><!--v-if-->
				</div>
				...
				<div class="delivery-info">
					...
					<dl>
						<dt>
							<button class="btn-tooltip" @click="showDeliveryTip">
								배달팁 <i class="btn_tooltip_16"></i>
							</button>
						</dt>
						<dd>3,000원 ~</dd>
					</dl>
			...
			<div class="btn-wrap-fixed-wrap">
				<div class="btn-wrap-fixed">
					<button class="btn-address btn-block-lg">
						주소를 설정하세요.
					</button>
				</div>
	...
	<transition name="fade">
		<BusinessTime v-if="!isBusinessTime" @close="closeBusinessTime" />
	</transition>
	<!-- 배달팁 -->
	<transition name="fade">
		<DeliveryTip v-if="isDeliveryTip" @close="closeDeliveryTip" />
	</transition>
</template>
...
@import '@/assets/default/scss/components/order/orderDashboardDvry';
@import '@/assets/default/scss/components/dashboardDvryInfo';
